	...
	//var userInfo = JSON.parse(sessionStorage.userInfo),
		...
		main = {
			init:function(){
				...
				$("#shopId").val(exports.getUrlString("merchantId"));
			},
			bindEvent:function(){
			...
			postData:function(){
				httpModule.ajaxRequest({
					...
					type:"POST",
					async:true,
					url:shopIp + "jst-finance-merchantFront/rest/merchantFront/forgetPwdByEmail",
					data:{
						merchantId:exports.getUrlString("merchantId"),
						passWord:exports.encryptPwd(resetPwd),//新密码
						passWordType:"1",
						rfkey:exports.getUrlString("rfkey"),
						token:exports.getUrlString("tken")
					},
					success:function(data){
						console.log(data);
						if(data.resType == "00"){
							window.location.href = "reset_by_email_three.html";
						}else{
