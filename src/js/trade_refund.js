		...
		bindEvent: function() {
			...
			tableEle.on("click", ".details", function() {
				...
				var payData = {
					...
					tranDate: resultData.tranCorePayOrderBeanList[index].tranDate,
					...
					refundStatus: resultData.tranCorePayOrderBeanList[index].refundStatus,
					remarkMsg: resultData.tranCorePayOrderBeanList[index].remark,
				}
				sessionStorage.setItem("tradeInfo", JSON.stringify(payData));
				window.location.href = "trade_refund_detail.html";
			});
		},
		//复选框事件
